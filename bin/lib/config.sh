...
DEFAULT_DOTFILES_REPO="https://github.com/G33KM44N38/dotfiles.git"
...
function _validate_config {
    ...
    if [[ ! "$DOTFILES_REPO" =~ ^https?:// && ! "$DOTFILES_REPO" =~ ^[^@]+@[^:]+:.+ ]]; then
...
# Repository URL
DOTFILES_REPO="https://github.com/G33KM44N38/dotfiles.git"
